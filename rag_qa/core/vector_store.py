...
class VectorStore:
    ...
    def add_documents(self, documents):
        ...
        for i, doc in enumerate(documents):
            ...
            sparse_vector = {}
            # 获取第 i 行对应的稀疏向量数据 [0.4, 0.2, 0, 0, 0.1]
            # 使用新版本 API：X[[i]] 来获取稀疏向量（避免 1D 切片问题）
    ...
    def hybrid_search_with_rerank(self, query, k=conf.RETRIEVAL_K, source_filter=None):
        ...
        sparse_query_vector = {}
        # 获取查询稀疏向量的第 0 行数据
        # 使用新版本 API：X[[0]] 来获取稀疏向量（避免 1D 切片问题）
...
if __name__ == "__main__":
    ...
    directory_path = r'E:\workspace\python\pythonProject\integrated_qa_system\rag_qa\data\ai_data'
